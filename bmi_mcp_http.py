...
if __name__ == "__main__":
    logger.info("正在启动BMI MCP服务 (STREAMABLE HTTP模式)...")
    logger.info("服务名称: %s", mcp.name)
    logger.info("使用传输方式: streamable-http")
    logger.info("服务将监听端口: 8000")
    
    # 运行MCP服务，使用Streamable HTTP方式
